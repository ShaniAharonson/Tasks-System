package com.johnBrice.tasks.config;
...
public class OpenAPIConfiguration {
    ...
    public OpenAPI defineOpenAPI(@Value("springdoc-openapi-ui") String serviceTitle, @Value("1.6.12") String serviceVersion){
        ...
        server.setDescription("our tasks api for development");
        ...
        Info info = new Info()
                .title("tasks Managment System API")
                .version("1.0")
                .description("This API exposes endpoints to tasks")
                .contact(myContact);
